...
<body>
    ...
    <br/>
    <span>{{__('3.1.หนี้สินในระบบแบบถูกกฏหมาย เป็นหนี้คงเหลือ').Str::padBoth($member->debt_type_1? number_format($member->debt_type_1): '', 20, '.').__('บาท')}}</span>
    <br/>
    <span>{{__('3.2.หนี้สินนอกระบบแบบถูกกฏหมาย เป็นหนี้คงเหลือ').Str::padBoth($member->debt_type_2? number_format($member->debt_type_2): '', 20, '.').__('บาท')}}</span>
    <br/>
    <span>{{__('3.3.หนี้สินนอกระบบแบบผิดกฏหมาย เป็นหนี้คงเหลือ').Str::padBoth($member->debt_type_3? number_format($member->debt_type_3): '', 20, '.').__('บาท')}}</span>
    <br/>
    <span>{{__('3.4.หนี้สินแบบสหกรณ์ เป็นหนี้คงเหลือ').Str::padBoth($member->debt_type_4? number_format($member->debt_type_4) : '', 20, '.').__('บาท')}}</span>
    <br/>
    ...
    <span>5.1.เป็นบุคคลที่มีอายุตั้งแต่ 20 ปีขึ้นไป ทั้งคนไทยหรือบุคคลต่างด้าวที่ทำงานและมีที่พักอาศัยอยู่ในประเทศไทย<br/>มาเป็นระยะเวลาไม่น้อยกว่า2 ปี</span>
    <br/>
    <span>5.2.เป็นผู้มีนิสัยอันดีงาม มีความรู้ ความเข้าใจ เห็นชอบด้วยหลักการ ระเบียบข้อบังคับ และการดำเนินงาน<br/>บริหารของกองทุนอิสระฯ  และสมัครใจเข้ามามีส่วนร่วมในกิจกรรมต่างๆ ของกองทุนอิสระฯ</span>
    <br/>
    ...
    <strong>11.การคิดค่าธรรมเนียมในการสมัครเข้าเป็นสมาชิกกองทุนอิสระฯ</strong> ตามโครงการช่วยเหลือแก้ไขหนี้สินแบบปลอดดอกเบี้ย<br/>11.1. ค่าธรรมเนียมแรกเข้า จำนวน 500 บาท<br/>11.2.ค่าบำรุงสมาชิกรายปี จำนวน 2,000 บาท<br/>11.3.เงินฝากสัจจะออมทรัพย์ จำนวนดังต่อไปนี้<br/>11.3.1.จำนวนมูลหนี้ต่ำกว่า 431,999 บาท ÷ 120 = จำนวนเงินฝากสัจจะออมทรัพย์ต่อเดือน<br/>11.3.2.จำนวนมูลหนี้ 432,000 บาท ขึ้นไป เงินฝากสัจจะออมทรัพย์ 3,600 บาทต่อเดือน<br/>
