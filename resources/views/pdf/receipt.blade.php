...
<header>
    ...
    <style>
        html { margin: 30px; }
        body { font-family: 'Sarabun', sans-serif; font-size: 13pt; }
        table { width: 100% }
        table.table-border, 
        table.table-border th, 
        table.table-border td { border: 1px solid black; border-collapse: collapse; }
        table.table-border th, 
        table.table-border td { padding: .25rem .5rem; }
...
<body>
    <table>
        <tbody>
            <tr>
                <td style="width: 20%; vertical-align: bottom;">เลมที่ {{ $book }}</td>
                <td style="width: 60%; text-align: center;"><img style="width: 240px;" src="{{ public_path('logo.png') }}"/></td>
    ...
    <div class="text-center" style="margin-top: 3rem">ธนาคาร ไทยพาณิชย์ จำกัด (มหาชน) สาขา บางนาทาวเวอร์</div>
